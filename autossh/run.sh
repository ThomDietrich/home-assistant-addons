...
if [ -z "$FORWARD_LOCAL_IP_ADDRESS" ] || [ "$FORWARD_LOCAL_IP_ADDRESS" = "null" ]; then FORWARD_LOCAL_IP_ADDRESS = "172.30.32.1"; fi
if [ -z "$FORWARD_LOCAL_PORT" ] || [ "$FORWARD_LOCAL_PORT" = "null" ]; then FORWARD_LOCAL_PORT = 8123; fi
